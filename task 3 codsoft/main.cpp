// task 3 codsoft internship TIC-TAC-TOE GAME  [10th,sep,2024]  [ 10.11 AM]
...
// this function is used to create the board 
...
// Function to place the player's symbol on the board
